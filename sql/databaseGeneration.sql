...
CREATE TABLE IF NOT EXISTS `libr`.`BOOKS_STATUSES` (
  `BOOK_STATUS` INT NOT NULL AUTO_INCREMENT,
  `BOOK_STATUS_DESC` VARCHAR(20) NULL,
  PRIMARY KEY (`BOOK_STATUS`),
  UNIQUE INDEX `BOOK_STATUS_UNIQUE` (`BOOK_STATUS` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `libr`.`BOOK_ENITIES` (
  `BOOK_ENITITY_ID` INT NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE INDEX `BOOK_ENITITY_ID_UNIQUE` (`BOOK_ENITITY_ID` ASC),
